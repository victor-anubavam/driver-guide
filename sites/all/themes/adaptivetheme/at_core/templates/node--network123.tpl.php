...
<article id="node-<?php print $node->nid; ?> networklandpage" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>> 
      ...
      <h2 class="field-label">Network Name: </h2><?php echo $node->field_network_name[und][0][taxonomy_term]->name;?>
      
      <h2 class="field-label">First Name: </h2><span class="contenttext"><?php print $title; ?></span>
