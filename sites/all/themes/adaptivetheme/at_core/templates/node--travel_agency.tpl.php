...
hide($content['links']);
?>
<article id="node-<?php print $node->nid; ?> agencylandpage" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>> 
        <h2 class="field-label">AGENCY NAME: <span class="contNorm"><?php print $title; ?></span></h2>
  </div>
  <input type="hidden" name="node_hid" id="node_hid" value="<?php print $node->nid; ?>"/>
        <div class="outer-field">
            <div class="inner-field">
                <h2 class="field-label">Email Id: <span class="contNorm"><?php if(isset($content['field_contact_email_id']['#object']->field_company_email_id['und'][0]['email'])){ print $content['field_contact_email_id']['#object']->field_company_email_id['und'][0]['email'];} ?></span></h2>
        <h2 class="field-label">Member Name: <span class="contNorm"><?php if(isset($node->field_member_name['und'][0]['taxonomy_term']->name)){echo $node->field_member_name['und'][0]['taxonomy_term']->name;}?></span></h2>
    ...
    <div>
         ...
         <div class="inner-field">
         <h2 class="field-label">First Name: <span class="contNorm"><?php if(isset($content['field_first_name']['#object']->field_first_name['und'][0]['value'])){ print $content['field_first_name']['#object']->field_first_name['und'][0]['value'];} ?></span></h2>
         ...
         <h2 class="field-label">Email Id: <span class="contNorm"><?php if(isset($content['field_contact_email_id']['#object']->field_contact_email_id['und'][0]['email'])){ print $content['field_contact_email_id']['#object']->field_contact_email_id['und'][0]['email'];} ?></span></h2>
         <h2 class="field-label">Position In Agency: <span class="contNorm"><?php if(isset($content['field_position_in_network']['#object']->field_position_in_network['und'][0]['value'])){ print $content['field_position_in_network']['#object']->field_position_in_network['und'][0]['value'];} ?></span></h2>
         </div>
        </div>
         <div class="outer-field">
         ...
         <div class="inner-field">
         <h2 class="field-label">Agency Business Filds: <span class="contNorm"><?php if(isset($content['field_agency_busines_filds'][0]['#markup'])){ print $content['field_agency_busines_filds'][0]['#markup'];} ?></span></h2>
