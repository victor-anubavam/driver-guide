...
?>
        <tr>
            ...
            <td width="20%" style="float:left" id="mem_<?php echo $rows[$i]['nid']; ?>">
                ...
                {
                   ?><a  href="javascript:void(0);" onclick="removeHeadQuarMembers('<?php echo $gid; ?>','<?php echo $rows[$i]['nid']; ?>');" class="btnLink"><div class="btn">REMOVE</div></a> 
                   <?php
                }
                else
                { ?>
                <a  href="javascript:void(0);" onclick="addHeadQuarMembers('<?php echo $gid; ?>','<?php echo $rows[$i]['nid']; ?>');" class="btnLink"><div class="btn">ADD</div></a>
                <?php
                }
                ?>
            </td>
